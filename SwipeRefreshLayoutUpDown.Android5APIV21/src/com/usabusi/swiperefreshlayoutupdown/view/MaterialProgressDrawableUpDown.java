 ...
 * @hide 
 */
class MaterialProgressDrawableUpDown extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawableUpDown(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size One of {@link MaterialProgressDrawableUpDown.LARGE} or
     *            {@link MaterialProgressDrawableUpDown.DEFAULT}
     */
